...
(function () {
  ...
  /* ================================================
     NAVIGATION — filter sync across all nav surfaces
     ================================================ */
  ...
  /* ================================================
     CLEAR COMPLETED — wire up all 3 trigger buttons
     ================================================ */
  ...
  function openClearConfirm() {
    ...
    const msg = `This will permanently remove ${count} completed task${count !== 1 ? 's' : ''}.`;
    document.getElementById('clear-confirm-count').textContent = msg;
  ...
  document.getElementById('clear-confirm-ok').addEventListener('click', () => {
    ...
    saveTasks();
    // If we were viewing completed, switch back to all
  ...
  function createCard(task, index) {
    ...
    const diffClass     = task.difficulty === 'hard' ? 'badge-hard' : task.difficulty === 'easy' ? 'badge-easy' : 'badge-diff-medium';
  ...
  /* Disable clear buttons when no completed tasks */
